export default function ProfileBio() {
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <p>
        I'm a Computer Engineer based in Halifax, Nova Scotia, currently working
        as a Graduate Software Engineer at Kainos. Outside of work, I enjoy
        producing music and watching hockey.
      </p>
      <a
