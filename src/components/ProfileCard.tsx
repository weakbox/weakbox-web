...
export default function ProfileCard({ image = "", description = "" }) {
  return (
    <div className="flex w-full flex-col items-center justify-between gap-4 rounded-sm bg-gray-50 p-4 text-gray-400 transition-transform duration-100 hover:scale-105 hover:shadow-lg">
